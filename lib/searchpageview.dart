...
class Videoplview extends StatefulWidget {
  Videoplview({super.key,required this.x});

  DocumentSnapshot<Object?> x;

  @override
  State<Videoplview> createState() => _VideoplState();
}

class _VideoplState extends State<Videoplview> {
                  ...
                  Center(
                    child: Container(
                      ...
                      child: TextButton(
                          ...
                          child: Text("All videos",style:GoogleFonts.aBeeZee(textStyle: TextStyle(fontSize: 14,color: Colors.black)),
                              )),
                    ),
                  )
                ],
